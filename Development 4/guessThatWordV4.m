%{
Program Discription + File Purpose: guessThatWordV4, contains 2 game modes,
easy and hard. In hard mode the user guesses a six letter word within 7 
attempts. In easy mode the user guesses a three letter word within 7 
attempts. The code also contains a dirver for a asciiArt function.The 
purpose of this code if to see if mode selection works with the rest of the 
code, and test the art dirver.
%}
...
fprintf("In this game it will be your job to guess the correct 6 or 3 letter word " + ...
